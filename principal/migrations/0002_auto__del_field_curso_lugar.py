...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Curso.lugar'
        db.delete_column('principal_curso', 'lugar')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Curso.lugar'
        raise RuntimeError("Cannot reverse this migration. 'Curso.lugar' and its values cannot be restored.")
